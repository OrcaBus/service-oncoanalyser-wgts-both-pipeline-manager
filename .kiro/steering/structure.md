...
│   ├── get_oncoanalyser_wgts_outputs_from_portal_run_id_py/
...
- **SSM prefix**: `/orcabus/workflows/oncoanalyser-wgts-dna-rna/`
- **Stack prefix**: `orca-onco-wgts-both`
- **Workflow name**: `oncoanalyser-wgts-dna-rna`
- **Lambda runtime**: Python 3.14 on ARM64
- **Upstream workflow names**: `oncoanalyser-wgts-dna`, `oncoanalyser-wgts-rna` (glue pattern dependencies)
