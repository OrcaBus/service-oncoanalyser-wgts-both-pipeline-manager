...
- **Amazon EventBridge** — event bus `OrcaBusMain`, source `orcabus.oncoanalyserwgtsboth`
- **AWS SSM Parameter Store** — configuration under `/orcabus/workflows/oncoanalyser-wgts-dna-rna/`
