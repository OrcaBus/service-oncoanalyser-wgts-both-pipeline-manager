...
function buildUpstreamLegacySucceededEventPattern(): EventPattern {
  return {
    ...
    detail: {
      workflowName: [ONCOANALYSER_WGTS_DNA_WORKFLOW_NAME, ONCOANALYSER_WGTS_RNA_WORKFLOW_NAME],
...
function buildUpstreamSucceededEventPattern(): EventPattern {
  return {
    ...
    detail: {
      workflow: {
        name: [ONCOANALYSER_WGTS_DNA_WORKFLOW_NAME, ONCOANALYSER_WGTS_RNA_WORKFLOW_NAME],
      },
      status: [SUCCEEDED_STATUS],
    },
  };
